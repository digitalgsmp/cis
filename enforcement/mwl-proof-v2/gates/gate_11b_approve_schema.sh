...
if ! grep -q "INSERT INTO eric_gate_approvals" /mnt/projects/cis/runtime/api/dashboard_api.py; then
...
for col in "${REQUIRED_COLUMNS[@]}"; do
  if ! grep -q "\b${col}\b" /mnt/projects/cis/runtime/api/dashboard_api.py; then
