...
- Writing/reviewing CIS specs: references/specs-and-relay.md + spec-review-checklist.md
- Work touching the three-layer architecture (UI, Abstraction, Hermes Backend)
