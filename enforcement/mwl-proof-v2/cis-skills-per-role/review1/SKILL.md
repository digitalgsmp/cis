...
- Any work touching the three-layer architecture
- Run-scoped verify / working-tree snapshot → `references/run-scoped-verify-snapshot.md`
...
- **[L1 Verification & Snapshots](references/l1_verification_snapshots.md)** — Run isolation failures, snapshot design, compensation scope
- Can be re-run safely (skips already-ingested sessions)
