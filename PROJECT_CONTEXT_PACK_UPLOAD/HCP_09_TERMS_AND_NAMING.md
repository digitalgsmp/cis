...
- **External Advisor Packet** — PROJECT_CONTEXT_PACK_UPLOAD/HCP_* files. Permanent interface for ChatGPT, Claude, and frontier-model escalation. Manually maintained until Tier 5.4–5.6; target: generated from spine and export-verified.
