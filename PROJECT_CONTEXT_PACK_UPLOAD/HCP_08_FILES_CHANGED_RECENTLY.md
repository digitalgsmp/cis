...
Generated: 2026-07-12 12:50 UTC | Run: run-3a1909ca27b8
Source: SQLite spine + config/hcp_static.yaml + config/agents_static.yaml
DO NOT MANUALLY EDIT — regenerate with tools/export/generate_hcp.py

## 3c677ea fix: increase GLM max_tokens to 1000 — reasoning model needs room to think before JSON output
...
## 18c9197 perf: use GLM-4.7-Flash (90 tok/s) as primary semantic drift model, Qwen as fallback
...
## 8f561ba feat: semantic drift detection via local Qwen3-VL-30B LLM
...
## c63a5aa fix: container enforcement — repair prompt for all 7 FINAL_JSON gaps
...
## 8ef52eb fix: verification phase gates — service_health, pyyaml, eric_approval, result tracking
