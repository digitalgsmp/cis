...
2. Fix session close to write handoff to /mnt/projects/cis/handoff/
3. Fix CIS Live — active session only broadcast (ADR-021)
4. Fix CIS Live — copy prompt replaces copy URL (ADR-023)
5. Replace hardcoded model slots with dynamic roster (ADR-024)
