...
ALLOWED_TRANSITIONS = {
    ...
    # ── Implementation stage (menter-reviewer-connection card) ──────────
    ('ERIC_APPROVAL_GATE',  'MENTER_BUILDING'),
    ('MENTER_BUILDING',     'MENTER_COMPLETE'),
    ('MENTER_COMPLETE',     'IMPL_REVIEW_PENDING'),
    ('IMPL_REVIEW_PENDING', 'IMPL_REVIEWING'),
    ('IMPL_REVIEWING',      'IMPL_REVIEW_COMPLETE'),
    ('IMPL_REVIEW_COMPLETE', 'APPLY_READY'),
    ('IMPL_REVIEW_COMPLETE', 'IMPL_REVISE_REQUESTED'),
    ('IMPL_REVIEW_COMPLETE', 'IMPL_ESCALATED'),
    ('IMPL_REVISE_REQUESTED', 'MENTER_BUILDING'),
    ('APPLY_READY',         'APPLIED'),
    ('APPLY_READY',         'APPLY_BLOCKED'),
    ('APPLY_BLOCKED',       'MENTER_BUILDING'),
    ('APPLY_BLOCKED',       'IDLE'),
    ('IMPL_ESCALATED',      'IDLE'),
    ('APPLIED',             'IDLE'),
}
...
UNIVERSAL_TO_ABORTED = {
    ...
    'MENTER_BUILDING', 'IMPL_REVIEW_PENDING', 'IMPL_REVIEWING'
}
UNIVERSAL_TO_ERROR = {
