# CIS — AGENTS.md
Generated: 2026-06-18 05:44 UTC | Run: run-verify | Latest pipeline: run-gate-20260618
...
## 4. Active Decisions
- [ADR-SEED-014] BLK-SEED-005 refresh-bug root cause: get_default_hermes_root collapses onto prime unit: BLK-SEED-005 was a false positive (verified 2026-06-16). Prime was never actively poisoned — --replace was the managed systemd process with correct HERMES_HOME. Root cause (get_default_hermes_root collapsing sibling homes) is a latent architectural risk, not a runtime emergency. Resolved.
